<%@ Page Title="Address Edit" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddressEdit.aspx.cs" Inherits="CustomerDatalayerWebForms.AddressEdit" %>
<asp:Content ID="Content8" ContentPlaceHolderID="MainContent" runat="server">

    <h1 class="text-center">Editing address #<%=Request.QueryString["addressId"] %></h1>

    <div class="text-center">

        <div class="form-group">
            <asp:Label Text="Customer ID" runat="server"></asp:Label>
            <asp:DropDownList ID="customerId" class="form-control center-block" runat="server" disabled="disabled"></asp:DropDownList>
        </div>
