...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="text-center">
        <div class="form-group">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="firstName" ErrorMessage="The length of the first name can be from 3 to 50 characters" ForeColor="Red" ValidationExpression="^[a-zA-Z0-9'@&#.\s]{3,50}$">
        ...
        <div class="form-group">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="lastName" ErrorMessage="The length of the last name can be from 3 to 50 characters" ForeColor="Red" ValidationExpression="^[a-zA-Z0-9'@&#.\s]{3,50}$">
            </asp:RegularExpressionValidator>
        </div>
        <div class="form-group">
